...
const translations = {
  ko: {
    ...
    'registration.success': '등록 완료!',
    'registration.success_desc': '프로필이 성공적으로 저장되었습니다.',
    'registration.error': '오류가 발생했습니다',
    'registration.error_desc': '정보 저장 중 문제가 발생했습니다. 다시 시도해주세요.',
  ...
  en: {
    ...
    'registration.success_desc': 'Your profile has been saved successfully.',
    'registration.error': 'Error Occurred',
    'registration.error_desc': 'There was a problem saving your information. Please try again.',
  ...
  vi: {
    ...
    'registration.success_desc': 'Hồ sơ của bạn đã được lưu thành công.',
    'registration.error': 'Đã Xảy Ra Lỗi',
    'registration.error_desc': 'Có vấn đề khi lưu thông tin của bạn. Vui lòng thử lại.',
  ...
  zh: {
    ...
    'registration.success_desc': '您的资料已成功保存。',
    'registration.error': '发生错误',
    'registration.error_desc': '保存您的信息时出现问题。请重试。',
