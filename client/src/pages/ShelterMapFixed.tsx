  ...
  const getText = (key: string) => {
    const texts: Record<string, Record<string, string>> = {
      ko: {
        ...
        legend: '범례',
        walking_route: '보행자 이동 경로',
        straight_distance: '직선 거리',
        tmap_route: '보행자 이동 경로',
        fallback_route: '직선 거리',
        location_map: '위치 지도',
      ...
      en: {
        ...
        tmap_route: 'Walking Route',
        fallback_route: 'Straight Distance',
      ...
      vi: {
        ...
        tmap_route: 'Lộ trình đi bộ',
        fallback_route: 'Khoảng cách thẳng',
